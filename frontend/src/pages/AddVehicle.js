...
<div className="form-field">
  <TextField
    type="text" // Important: Use "text" instead of "number" for better input control
    inputProps={{ inputMode: "decimal" }} // Brings up numeric keyboard on mobile
