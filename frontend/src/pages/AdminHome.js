...
const AdminHome = () => {
        ...
        <Grid container spacing={3} justifyContent="center">
          <Grid item xs={12} sm={6} md={2.4}>
            <StatCard
              ...
              title="Admin Name"
              value={stats?.adminName || 'Kunal Khude'}
            />
          </Grid>
          <Grid item xs={12} sm={6} md={2.4}>
            <StatCard
  ...
  <li>
    <strong>Admin Info:</strong> 
     {stats?.adminName || 'Kunal Khude'} - The administrator responsible for managing vehicle listings, user data, and bookings on the platform.
  </li>
  <li>
